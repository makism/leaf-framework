 ...
 <body>
  ...
  <div id="Container">
    ...
    <div id="Intro">
		...
		εφαρμογές που υπάρχουν στον υποκατάλογο<cite>applications</cite>
		και επιπλέον, συμβουλευτείτε το <cite>εχγειρίδιο χρήσης</cite> ή και το <cite>api doc</cite>.</p>

		<p>Μην ξεχνάτε να επισκέπτεστε συχνά το sourceforge.net/projects/leaf-framework
		για νέα και ενημερώσεις.</p>
        
        <br />
        <p id="thankyou">Σας ευχαριστούμε για το ενδιαφέρον σας :-)</p>
    </div>
  </div>
